    ...
    if (responseJobData.ok === true) {
      ...
      const updatedJobDetailsData = [fetchedJobData.job_details].map(
        eachItem => ({
          ...
          interviewers: eachItem.interviewers || [],
        }),
      )
          ...
          <div className="job-item-container">
            ...
            <div className="second-part-container">
              <div className="description-visit-container">
                ...
                <a className="visit-anchor" href={companyWebsiteUrl} target="_blank" rel="noopener noreferrer">
            ...
            {interviewers.length > 0 && (
              <div className="interviewers-container">
                <h1 className="interviewers-heading">Interviewers</h1>
                <ul className="interviewers-list">
                  {interviewers.map(interviewer => (
                    <li className="interviewer-item" key={interviewer.name}>
                      <img src={interviewer.image_url} alt={interviewer.name} className="interviewer-img" />
                      <div>
                        <p className="interviewer-name">{interviewer.name}</p>
                        <p className="interviewer-role">{interviewer.role}</p>
                      </div>
                    </li>
                  ))}
                </ul>
